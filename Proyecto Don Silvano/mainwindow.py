...
class MainWindow(QMainWindow) :
    def __init__(self) :
        ...
        self.ui.reestablecer_pushbutton.clicked.connect(self.reestablecer)
    ...
    def reestablecer(self):
        ...
        self.lista = []  
        self.ui.tabla.clear() 
        self.ui.tabla.setColumnCount(0)
        self.ui.tabla.setRowCount(0)
        QMessageBox.information(
            self,
            'REESTABLECIDO',
            'Se han reestablecido todos los contactos para empezar de nuevo con la búsqueda'
        )
