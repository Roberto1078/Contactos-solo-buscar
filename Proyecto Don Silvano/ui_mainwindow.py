...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        font2.setBold(True)
        font2.setWeight(75)
        self.agregar_guardar_pushbutton.setFont(font2)
        ...
        self.label_16.setGeometry(QRect(10, 420, 121, 21))
        ...
        self.link_lineedit.setGeometry(QRect(130, 420, 751, 21))
        ...
        font4 = QFont()
        font4.setFamily(u"Yu Gothic Medium")
        font4.setPointSize(11)
        self.busqueda_lineedit.setFont(font4)
        self.busqueda_lineedit.setStyleSheet(u"")
        self.busqueda_lineedit.setClearButtonEnabled(True)
        self.buscar_pushbutton = QPushButton(self.tab_2)
        self.buscar_pushbutton.setObjectName(u"buscar_pushbutton")
        self.buscar_pushbutton.setGeometry(QRect(700, 540, 151, 51))
        self.buscar_pushbutton.setFont(font2)
...
"image: url(:/imagenes/lupa 2.ico);")
        ...
        self.reestablecer_pushbutton.setFont(font2)
...
"background-color: rgb(225, 82, 101);")
        ...
        self.widget_4.setStyleSheet(u"background-color: rgb(236, 232, 235);")
        icon1 = QIcon()
        ...
        self.menubar.setGeometry(QRect(0, 0, 1054, 21))
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Pront", None))
        ...
        self.direccion_lineedit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Ejemplo. Calle Miguel #928", None))
        ...
        self.label_16.setText(QCoreApplication.translate("MainWindow", u"Link (Pagina Web):", None))
